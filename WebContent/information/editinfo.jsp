		...
		<body>
			<div id="main">
				...
				<div id="content">
					...
					<div class="wrapper">
							<div class="wrapper">
								<form class="" action="/activity/information/update.action?id=${id}" method="post" onsubmit="return requestData()">
									<div class="input-group">
									<span class="input-group-addon">咨询名称：</span>
									<input id="art_name" name="name" value = "${info.name}" class="form-control" type="text" />
									</div>
									<br/>
			...
			<script type="text/javascript">
				...
				$(function() {
					$.ajax({
					    url:"http://magic.puckart.com/activity/information/querybyid.action?id=" + '<%=s2%>', 
					    dataType:"json",
					    async: false,
					...
					editor.customConfig.uploadImgServer = 'http://magic.puckart.com/activity/MagicUpload';
					editor.create();
