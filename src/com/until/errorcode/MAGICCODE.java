...
public class MAGICCODE
{
	...
	public static int PRODUCTION_NOT_IN_ACTIVITY = 60000;
	public static int PRODUCTION_IN_ACTIVITY = 60001;
	
	public static int ACTIVITY_NOT_EXIST = 70000;
	public static int ACTIVITY_EXIST = 70001;
